"""Field extraction via Claude vision.

The original engine: page images go to the model, which returns the fields plus
a self-reported confidence score per field. Kept alongside the Textract engine
...
from app.extract import image_to_b64, pdf_to_images
